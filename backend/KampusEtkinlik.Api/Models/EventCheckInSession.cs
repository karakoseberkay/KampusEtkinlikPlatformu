...
public class EventCheckInSession // etkinlik için oluşturulan qr kod oturumunu temsil eder
{
    ...
    // qr kodun hangi etkinliğe ait olduğunu tutar


    public Event Event { get; set; } = null!;
    // qr kodun bağlı olduğu etkinlik nesnesine ulaşmamızı sağlar


    public string TokenHash { get; set; } = string.Empty;
    // qr kod içerisinde kullanılan tokenın hashlenmiş halini tutar


    public DateTimeOffset CreatedAt { get; set; } = DateTimeOffset.UtcNow;
    // qr kodun oluşturulduğu zamanı tutar
    ...
    // qr kodun aktif olup olmadığını tutar
}