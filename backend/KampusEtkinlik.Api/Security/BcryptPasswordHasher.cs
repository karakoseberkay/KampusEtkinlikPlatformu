...
public sealed class BcryptPasswordHasher: IPasswordHasher<ApplicationUser> // Identity'nin parola hashleme sözleşmesini BCrypt ile gerçekleştirir
{
        ...
        string password) // kullanıcının düz metin parolası
    {
        ...
        return BCrypt.Net.BCrypt.HashPassword(password); // parolayı BCrypt ile geri çözülemeyen hash halinde döndürür
    }
        ...
        string providedPassword) // kullanıcının login sırasında yazdığı parola
    {
        ...
        // kayıtlı hash veya girilen parola boşsa doğrulama yapmaz
        {
        ...
        //parola doğruysa başarılı sonucu döndürür yanlışsa başarısız sonucu döndürür
    }
}