...
public sealed class RegistrationResponse // backendden frontende dönecek etkinlik kayıt bilgilerini taşır
{
    ...
    public DateTimeOffset? CheckedInAt { get; set; } // kullanıcı qr ile giriş yaptıysa check-in zamanını döndürür yapmadıysa null olur
}