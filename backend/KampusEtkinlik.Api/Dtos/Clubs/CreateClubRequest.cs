...
public sealed class CreateClubRequest // frontendden kulüp oluşturma endpointine gelecek bilgileri taşır
{
    [Required] // kulüp adının boş gönderilmesini engeller
    [MaxLength(150)] // kulüp adı en fazla 150 karakter olabilir
    public string Name { get; set; } = string.Empty; // oluşturulacak kulübün adını alır


    [MaxLength(1000)] // açıklama varsa en fazla 1000 karakter olabilir
    public string? Description { get; set; } // oluşturulacak kulübün açıklamasını alır, boş bırakılabilir
