...
// EventStatus enumuna erişmemizi sağlar

namespace KampusEtkinlik.Api.DTOs.Clubs; 
// bu dosyanın Clubs DTOları altında olduğunu belirtir


public sealed class ClubEventStatsResponse 
// kulüp istatistiklerinde her etkinlik için frontend'e dönecek bilgileri taşır
{
    ...
    // onaylanan kayıtların etkinlik kapasitesine göre yüzdesini döndürür
}