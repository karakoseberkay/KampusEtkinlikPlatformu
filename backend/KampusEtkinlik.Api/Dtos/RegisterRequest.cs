...
public sealed class RegisterRequest // frontendden register endpointine gelecek kayıt bilgilerini taşır
{
    ...
    [MaxLength(150)] // FullName en fazla 150 karakter olabilir
    public string FullName { get; init; } = string.Empty; // kullanıcının ad soyad bilgisini alır
    ...
    public string Email { get; init; } = string.Empty; // kullanıcının eposta bilgisini alır
    ...
    public string Password { get; init; } = string.Empty; // kullanıcının kayıt sırasında gönderdiği düz metin parolayı alır


    [MaxLength(150)] // Department doluysa en fazla 150 karakter olabilir
    public string? Department { get; init; } // kullanıcının bölüm bilgisini alır, boş bırakılabilir
}